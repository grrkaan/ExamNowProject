...
<!-- SIDEBAR -->
        ...
        <div class="panel form-style-6" style="max-width: 420!important;">   
        ...
        <option value="<%=list.get(i)%>"><%=list.get(i)%></option>
            ...
            %>
                       ...
                       <tr>
                           ...
                           <td colspan="4"><input type="text" name="question" class="text" placeholder="Question Here" style="width: 420px;" ></td><br>
                       </tr>
                       <tr>
