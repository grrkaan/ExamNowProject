					...
					<div class="carousel-caption">
						<div class="container">
							<div class="col-md-6 col-sm-8 col-xs-8 ow-pull-right no-padding">
								<h4 data-animation="animated bounceInLeft">Welcome To</h4>
								<h3 data-animation="animated fadeInDown"><span>Exam Now</span></h3>
								<p data-animation="animated bounceInRight">I belive nothing is more important than education.</p>
								<a href="about-page.html" title="Learn More" data-animation="animated zoomInUp">Learn More</a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="welcome-box">
					...
					<div class="welcome-content">
						...
						<ul class="course-detail">
							<li><i class="fa fa-clock-o" aria-hidden="true"></i>Exam Time : <span>30 Dk</span></li>
							<li><i class="fa fa-graduation-cap" aria-hidden="true"></i>Degree Level : <span>Beginner Degree</span></li>
							<li><i class="fa fa-check" aria-hidden="true"></i>Total Mark : <span>100</span></li>
						</ul>
		...
		<div class="parallax-carousel">
			<div class="parallax-block">
				...
				<div class="parallax-content">
					...
					<a href="about-page.html" title="Find More About Us">Find More About Us</a>
